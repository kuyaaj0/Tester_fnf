...
class HScript {
	...
	public function get(name:String) {
		if(interp.directorFields.exists(name)) {
			return interp.directorFields.get(name);
		} else if(interp.directorFields.exists(name + ";const")) {
			return interp.directorFields.get(name + ";const");
		} else {
	...
	public function exists(name:String) {
		return interp.variables.exists(name) || interp.directorFields.exists(name) || interp.directorFields.exists(name + ';const');
	}
