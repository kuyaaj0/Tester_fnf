...
class OptionsSubLang
{
	static var data:OptionSubData;
	static var defaultData:OptionSubData;
	...
	{
		if (FileSystem.exists(Paths.getPath('language') + '/' + 'English' + '/optionsSub.json'))
			data = defaultData = Json.parse(Paths.getTextFromFile('language/' + 'English' + '/optionsSub.json'));
		if (FileSystem.exists(Paths.getPath('language') + '/' + ClientPrefs.data.language + '/optionsSub.json'))
			data = Json.parse(Paths.getTextFromFile('language/' + ClientPrefs.data.language + '/optionsSub.json'));
	}
}
