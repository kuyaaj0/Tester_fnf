...
function startIntro()
{
	...
	if (IsNum(titleJSON.titlescalex))
		logoBl.scale.x = titleJSON.titlescalex;
	if (IsNum(titleJSON.titlescaley))
	...
	if (IsNum(titleJSON.startscalex))
		titleText.scale.x = titleJSON.startscalex;
	if (IsNum(titleJSON.startscaley))
		titleText.scale.y = titleJSON.startscaley;
