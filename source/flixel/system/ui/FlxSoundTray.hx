...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
    	...
    	shape.graphics.drawRoundRect(0, 0, _width*2, 60, 10, 10);
    	shape.graphics.endFill();
    
    	var tmp:Bitmap = new Bitmap(new BitmapData(_width*2, 60, true, 0x0));
    	tmp.bitmapData.draw(shape);
		tmp.scaleX = tmp.scaleY = 0.5;
		screenCenter();
		addChild(tmp);
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Assets.getFont("assets/fonts/FPS.ttf").fontName, 10, 0xffffff);
